...
# Calculate winners mean and sd for wing length 
...
# Calculate losers mean and sd for wing length 
...
#####Model - Fresh mass (named weight)####

#Searching for outliers
plot(id_focal_outcome~fresh_weight, bty='l',ylab='Probability of winning',xlab="Fresh mass (g)",bty="l",rhp) #no outlier
...
# Calculate winners mean and sd for fresh mass
...
# Calculate losers mean and sd for fresh mass
...
plot(id_focal_outcome~scaled_fresh_weight, bty='l',ylab='Probability of winning',xlab="Scaled fresh mass (g)",bty="l",rhp)

curve(predict(model_log_fresh_weight,data.frame(scaled_fresh_weight=x), type="resp"), add=T)

#####Model - Thorax dry mass (named weight)####

#Searching for outliers
plot(id_focal_outcome~thorax_dry_weight, bty='l',ylab='Probability of winning',xlab="Thorax dry mass (g)",bty="l",rhp)
...
# Calculate winners mean and sd for Thorax dry mass
...
# Calculate losers mean and sd Thorax dry mass
...
plot(id_focal_outcome~scaled_thorax_dry_weight, bty='l',ylab='Probability of winning',xlab="Scaled thorax dry mass (g)",bty="l",rhp_thorax_dry_weight) 
...
#Searching for outliers
plot(id_focal_outcome~abdomen_dry_weight, bty='l',ylab='Probability of winning',xlab="Abdomen dry mass (g)",bty="l",rhp)
...
# Calculate winners mean and sd for Abdomen dry weight
...
# Calculate losers mean and sd Abdomen dry weight
...
plot(id_focal_outcome~scaled_abdomen_dry_weight, bty='l',ylab='Probability of winning',xlab="Scaled abdomen dry mass (g)",bty="l",rhp_abdomen_dry_weight) 

curve(predict(model_log_abdomen_dry_weight,data.frame(scaled_abdomen_dry_weight=x), type="resp"), add=T)

#####Model - Total dry mass (named weight)####

#Searching for outliers
plot(id_focal_outcome~total_dry_weight, bty='l',ylab='Probability of winning',xlab="Total dry mass (g)",bty="l",rhp_total_dry_weight)
...
# Calculate winners mean and sd for Total dry mass
...
# Calculate losers mean and sd Total dry mass
...
plot(id_focal_outcome~scaled_total_dry_weight, bty='l',ylab='Probability of winning',xlab="Scaled total dry mass (g)",bty="l",rhp_total_dry_weight)

curve(predict(model_log_total_dry_weight,data.frame(scaled_total_dry_weight=x), type="resp"), add=T)


#####Model - Thorax fat mass (named weight)####

#Searching for outliers
plot(id_focal_outcome~thorax_fat_weight, bty='l',ylab='Probability of winning',xlab="Thorax fat mass (g)",bty="l",rhp)
...
# Calculate winners mean and sd for Thorax fat mass
...
# Calculate losers mean and sd Thorax fat mass
...
plot(id_focal_outcome~scaled_thorax_fat_weight, bty='l',ylab='Probability of winning',xlab="Scaled thorax fat mass (g)",bty="l",rhp_thorax_fat_weight) #no outlier

curve(predict(model_log_thorax_fat_weight,data.frame(scaled_thorax_fat_weight=x), type="resp"), add=T)


#####Model - Abdomen fat mass (named weight)####

#Searching for outliers
plot(id_focal_outcome~abdomen_fat_weight, bty='l',ylab='Probability of winning',xlab="Abdomen fat mass (g)",bty="l",rhp)

#Leaving only complete lines
rhp_abdomen_fat_weight = rhp[complete.cases(rhp),] 

#Scaling abdomen fat mass
...
# Calculate winners mean and sd for Abdomen fat mass
...
# Calculate losers mean and sd Abdomen fat mass
...
plot(id_focal_outcome~scaled_abdomen_fat_weight, bty='l',ylab='Probability of winning',xlab="Scaled abdomen fat mass (g)",bty="l",rhp_abdomen_fat_weight) 
...
# Calculate winners mean and sd for Total fat mass
...
# Calculate losers mean and sd Total fat mass
...
plot(id_focal_outcome~scaled_total_fat_weight, bty='l',ylab='Probability of winning',xlab="Scaled total fat mass (g)",bty="l",rhp_total_fat_weight) 
...
#Linear regression between fat and fresh mass
...
#Searching for outliers
plot(id_focal_outcome~residuals_thorax, bty='l',ylab='Probability of winning',xlab="Residuals of thorax fat mass in relation to thorax fresh mass (g)",bty="l",rhp)
...
# Calculate winners mean and sd for Residuals fat mass 
...
# Calculate losers mean and sd Residuals fat mass
...
#####Figure Thorax residuals of fat mass####

model_log_residuals_thorax=glm(id_focal_outcome~scaled_thorax_residuals,family=binomial,data=rhp)

plot(id_focal_outcome~scaled_thorax_residuals, bty='l',ylab='Probability of winning',xlab="Scaled residuals thorax fat mass (g)",bty="l",rhp) 
...
#Searching for outliers
plot(id_focal_outcome~residuals_abdomen, bty='l',ylab='Probability of winning',xlab="Residuals of abdomen fat in relation to abdomen fresh mass (g)",bty="l",rhp)
...
# Calculate winners mean and sd for Residuals fat abdomen
...
# Calculate losers mean and sd Residuals fat abdomen
...
#####Figure Abdomen residuals of fat mass####

model_log_residuals_abdomen=glm(id_focal_outcome~scaled_residuals_abdomen,family=binomial,data=rhp_residuals_abd)

plot(id_focal_outcome~scaled_residuals_abdomen, bty='l',ylab='Probability of winning',xlab="Scaled residuals abdomen fat mass (g)",bty="l",rhp_residuals_abd) 
...
# Calculate winners mean and sd for hue of reflectance
...
# Calculate winners mean and sd for Chroma Reflection
...
# Calculate losers mean and sd Chroma Reflection
...
# Calculate winners mean and sd for Brightness reflection
...
# Calculate losers mean and sd for Brightness reflection
...
# Calculate winners mean and sd for Transmittance Hue
...
# Calculate losers mean and sd Transmittance Hue
...
#Scaling Chroma of Transmittance
...
# Calculate winners mean and sd for Chroma of Transmittance
...
# Calculate losers mean and sd Chroma of Transmittance
...
#Scaling Brightness of Transmittance
...
# Calculate winners mean and sd for Brightness of Transmittance
...
# Calculate losers mean and sd for Brightness of Transmittance
